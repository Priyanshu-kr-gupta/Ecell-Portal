  ...
  return (
    ...
    <Toaster/>
      <div className="bg-white hadow-lg rounded-lg max-w-md w-full p-8 z-0 ">
        ...
        <button onClick={handleSubmit} disabled={isLoading} className="w-full bg-gradient-to-r from-[#1a2a6c] to-[#0f1a3d] text-white font-semibold py-2 rounded-md hover:bg-gradient-to-r hover:from-[#25334d] hover:to-[#162243] transition-colors duration-300 flex items-center justify-center">
          {isLoading ?"Wait":"Login"}
        </button>

         <p className="text-center text-sm text-gray-500 mt-6">
          Don't have an Account?
          <Link to={"/register"} className='text-[#25334d] underline'> Register</Link>
        </p>
        {/* <p className="text-center text-sm text-gray-500 mt-6">
